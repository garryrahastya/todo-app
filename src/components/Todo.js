...
function TodoList() {
  ...
  return (
    <div className={style.container}>
      ...
      />
      <button className={style["add-button"]}onClick={handleAddTodo}>Add Todo</button>
      
      </div>
      <ul className={style["todo-list"]}>
        {todos.map((todo) => (
          <li key={todo.id} className={style["todo-item"]}>
            <button className={style["delete-button"]} onClick={() => handleDeleteTodo(todo.id)}>Delete</button>
            <span
              style={{
            ...
            <button className={style["toggle-button"]} onClick={() => handleToggleTodo(todo.id)}>
